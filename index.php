...
$articles = [46,36,58,32];
if(isset($_GET['add_to_cart'])){

          if (in_array($_GET['add_to_cart'] , $articles)){

                $qtyCookie = $_GET['add_to_cart'];

                if (!isset($_SESSION['qtyCookie'][$qtyCookie])){

                    $_SESSION['qtyCookie'][$qtyCookie] = 1 ;
                } else {
                    $_SESSION['qtyCookie'][$qtyCookie] += 1 ;
